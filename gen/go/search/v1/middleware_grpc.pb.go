...
func (c *privateMiddlewareServiceClient) RegisterChannel(ctx context.Context, in *RegisterChannelRequest, opts ...grpc.CallOption) (*RegisterChannelResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/search.v1.PrivateMiddlewareService/RegisterChannel", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *privateMiddlewareServiceClient) RegisterApp(ctx context.Context, in *RegisterAppRequest, opts ...grpc.CallOption) (PrivateMiddlewareService_RegisterAppClient, error) {
	stream, err := c.cc.NewStream(ctx, &PrivateMiddlewareService_ServiceDesc.Streams[0], "/search.v1.PrivateMiddlewareService/RegisterApp", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *privateMiddlewareServiceClient) AppSend(ctx context.Context, in *ApplicationMessageOut, opts ...grpc.CallOption) (*AppSendResponse, error) {
	out := new(AppSendResponse)
	err := c.cc.Invoke(ctx, "/search.v1.PrivateMiddlewareService/AppSend", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *privateMiddlewareServiceClient) AppRecv(ctx context.Context, in *AppRecvRequest, opts ...grpc.CallOption) (*ApplicationMessageIn, error) {
	out := new(ApplicationMessageIn)
	err := c.cc.Invoke(ctx, "/search.v1.PrivateMiddlewareService/AppRecv", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPrivateMiddlewareServiceServer) AppSend(context.Context, *ApplicationMessageOut) (*AppSendResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AppSend not implemented")
}
func (UnimplementedPrivateMiddlewareServiceServer) AppRecv(context.Context, *AppRecvRequest) (*ApplicationMessageIn, error) {
...
func _PrivateMiddlewareService_RegisterChannel_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/search.v1.PrivateMiddlewareService/RegisterChannel",
	}
...
func _PrivateMiddlewareService_AppSend_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/search.v1.PrivateMiddlewareService/AppSend",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PrivateMiddlewareServiceServer).AppSend(ctx, req.(*ApplicationMessageOut))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _PrivateMiddlewareService_AppRecv_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/search.v1.PrivateMiddlewareService/AppRecv",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (c *publicMiddlewareServiceClient) InitChannel(ctx context.Context, in *InitChannelRequest, opts ...grpc.CallOption) (*InitChannelResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/search.v1.PublicMiddlewareService/InitChannel", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *publicMiddlewareServiceClient) StartChannel(ctx context.Context, in *StartChannelRequest, opts ...grpc.CallOption) (*StartChannelResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/search.v1.PublicMiddlewareService/StartChannel", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *publicMiddlewareServiceClient) MessageExchange(ctx context.Context, opts ...grpc.CallOption) (PublicMiddlewareService_MessageExchangeClient, error) {
	stream, err := c.cc.NewStream(ctx, &PublicMiddlewareService_ServiceDesc.Streams[0], "/search.v1.PublicMiddlewareService/MessageExchange", opts...)
	if err != nil {
		return nil, err
	}
...
func _PublicMiddlewareService_InitChannel_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/search.v1.PublicMiddlewareService/InitChannel",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PublicMiddlewareService_StartChannel_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/search.v1.PublicMiddlewareService/StartChannel",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
